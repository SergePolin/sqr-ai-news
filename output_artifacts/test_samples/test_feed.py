...
def test_get_channels_with_articles_empty(test_user, clean_user_channels, clean_articles):
...
def test_get_channels_with_articles(test_user, test_db, clean_user_channels, clean_articles):
    ...
    article_data = {
        ...
        "source": "@test_channel",
        "published_date": datetime(2025, 1, 1, 12, 0, 0)  # Use datetime object instead of string
    }
...
def test_process_channel_articles(mock_bs, mock_category, mock_summary, mock_parse, mock_get, test_db, clean_articles):
    ...
    # Mock BeautifulSoup
    mock_soup = MagicMock()
    mock_soup.get_text.return_value = "This is a long text that is more than 50 characters to pass the length check"
...
def test_delete_article_bookmark(mock_remove_bookmark, test_user, test_db, clean_articles):
...
def test_list_user_bookmarks(mock_get_article, mock_get_user_bookmarks, test_user, test_db, clean_articles):
