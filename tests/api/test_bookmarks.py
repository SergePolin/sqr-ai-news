...
from app.db.models import User, NewsArticle, Bookmark
from app.db.crud import get_user_by_username, create_or_update_article, add_bookmark, is_bookmarked
...
def test_list_bookmarks(test_db: Session, clean_db):
    ...
    logger.debug(f"List bookmarks response body: {response.text[:500]}...")  # Truncated for large responses
